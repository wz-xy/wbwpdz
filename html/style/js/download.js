$(function(){
	...
	//banner背景
	let srcd="url("+$(".banner img").prop("src")+") no-repeat center top"
	$(".banner").css("background",srcd)
	//bannerbot背景
	let srcdb="url("+$(".bannerbot img").prop("src")+") no-repeat center top"
	$(".bannerbot").css("background",srcdb)
})
